...
//        mSalt = SharePref.getInstance().getString(SharePref.PAYTM_MERCHANT_SALT);
        ...
        Funtions.LOGE("PaymentGetWay","mMerchantKey :"+mMerchantKey);
        Funtions.LOGE("PaymentGetWay","mSalt :"+mSalt);
        ...
        PayUCheckoutPro.open(context,
                ...
                new PayUCheckoutProListener() {
                    ...
                    public void onPaymentSuccess(Object response) {
                        ...
                        Funtions.LOGE("PayuMoney",""+result);
                    ...
                    public void onError(ErrorResponse errorResponse) {
                        ...
                        Funtions.LOGE("PayuMoney",""+errorMessage);
...
//                             else {
                                ...
                                Funtions.LOGE("PaymentGetWay","HashData :"+hashData);
                                Funtions.LOGE("PaymentGetWay","hash :"+hash);

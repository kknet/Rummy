...
public class PayUMoneyActivity extends AppCompatActivity {
    ...
    */
    ...
    // Final Variables
    private String mMerchantKey = "1LsH6RDv";
    private String mSalt = "Dvtl7mVGgL";
    private String mBaseURL = "https://test.payu.in";
...
//        ab.setTitle(getString(R.string.title_activity_online_payment));
    ...
    private void initiatepayment(String plan_id){
        ...
        ApiRequest.Call_Api(this, Const.payu_token, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                try {
                    ...
                    if (code.equals("200")){
                        ...
                        mTXNId=jsonObject.getString("order_id");
//                        mAmount =jsonObject.getDouble("Total_Amount");
//                        payumoney_string = jsonObject.getString("payumoney_string");

                        JSONObject paymentbody = jsonObject.getJSONObject("payumoney_body");
                        mProductInfo = paymentbody.getString("plan_id");
//                        orderId = paymentbody.getString("orderId");
                        mFirstName = paymentbody.getString("name");
                        mPhone = paymentbody.getString("mobile");
                        mEmailId = paymentbody.getString("email");
                        mAmount = paymentbody.getDouble("amount");
...
//            mTXNId = hashCal("SHA-256", randomString).substring(0, 20);
             ...
             * Creating Hash Key
             */
//           String local_mHash = hashCal("SHA-512", mMerchantKey + "|" +
//                    mTXNId + "|" +
//                    mAmount + "|" +
//                    mProductInfo + "|" +
//                    mFirstName + "|" +
...
//           Funtions.LOGE("Local_Hash_Value","\n"+mMerchantKey + "|" +
//                   mTXNId + "|" +
//                   mAmount + "|" +
//                   mProductInfo + "|" +
//                   mFirstName + "|" +
//                   mEmailId + "|||||||||||" +
//                   mSalt);
//           Funtions.LOGE("Local_Hash",""+local_mHash);

package com.gamegards.allinonev3._DragonTiger;
...
//                            VisiblePleasewaitforNextRound(true);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            ...
            case R.id.rltTie:
            {
                Funtions.showToast(context,"Comming Soon!");
//                AddBet(TIE);
            }
            break;
...
//        count = 0;
    ...
    public void onBackPressed() {
        ...
        Funtions.Dialog_CancelAppointment(context, "Confirmation", "Leave ?", new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {
                if(resp.equals("yes"))
                {

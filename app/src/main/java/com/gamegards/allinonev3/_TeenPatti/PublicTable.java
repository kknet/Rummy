...
import static com.gamegards.allinonev3.Utils.Variables.TEENPATTIPUBLIC;
...
//                   txtPlay1wallet.setText("" + NumberFormat.getNumberInstance(Locale.US).format(numberwallet));
        ...
        Picasso.with(context).load(Const.IMGAE_PATH + img).into(imgpl1circle);
        ...
        imgpl1show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (playercount > 2) {
                    ...
                    //Toast.makeText(context, "Side Show Coming Soon.", Toast.LENGTH_LONG).show();
...
//                                        txtPlay2wallet.setText("" + numberamount);
                                        ...
                                        Picasso.with(context).load(Const.IMGAE_PATH + profile_pic1).into(imgpl2circle);
...
//                                        txtPlay3wallet.setText("" + numberamount);
                                        ...
                                        Picasso.with(context).load(Const.IMGAE_PATH + profile_pic3).into(imgpl3circle);
...
//                                        txtPlay4wallet.setText("" + numberamount);
                                        ...
                                        Picasso.with(context).load(Const.IMGAE_PATH + profile_pic4).into(imgpl4circle);
...
//                                        txtPlay5wallet.setText("" + numberamount);
                                        ...
                                        Picasso.with(context).load(Const.IMGAE_PATH + profile_pic5).into(imgpl5circle);
...
//        Toast.makeText(context, ""+total_cards, Toast.LENGTH_SHORT).show();
    ...
    public void makeleavetable() {
        ...
        Picasso.with(context).load(imageResource).into(imgpl1circle);
        Picasso.with(context).load(imageResource).into(imgpl2circle);
        Picasso.with(context).load(imageResource).into(imgpl3circle);
        Picasso.with(context).load(imageResource).into(imgpl4circle);
        Picasso.with(context).load(imageResource).into(imgpl5circle);
                        ...
                        try {
                            ...
                            if (code.equalsIgnoreCase("200")) {
                                ...
                                if (jsonObject.has("cards")) {
                                    ...
                                    if (jsonObject.has("message")) {
                                        String message = jsonObject.getString("message");
//                                        Toast.makeText(context, "Wrong mobile number or password",
//                                                Toast.LENGTH_LONG).show();
                                    }
